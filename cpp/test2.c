...
void llenarVariablesEntrada()
{
    ...
    VariablesEntrada[0].intervalo=0.066667;
...
void llenarVariablesSalida()
{
    ...
    VariablesSalida[0].intervalo=0.066667;
...
void llenarEntradas()
{
    ...
    Entradas[0].maximo=-0.500000;

    Entradas[1].minimo=-1.000000;
    Entradas[1].maximo=0.000000;

    Entradas[2].minimo=-0.500000;
    Entradas[2].maximo=0.500000;

    Entradas[3].minimo=0.000000;
    Entradas[3].maximo=1.000000;

    Entradas[4].minimo=0.500000;
    Entradas[4].maximo=1.000000;

    Entradas[5].minimo=-1.000000;
    Entradas[5].maximo=0.000000;

    Entradas[6].minimo=-1.000000;
    Entradas[6].maximo=1.000000;

    Entradas[7].minimo=0.000000;
    Entradas[7].maximo=1.000000;
...
void llenarDifusores()
{
    ...
    Difusores[0].intervalo=0.005000;
    ...
    Difusores[1].intervalo=0.005000;
...
void llenarCentrosAltura()
{
    ...
    CentrosAltura[1][0]=-1.000000;
    CentrosAltura[2][0]=-0.500000;
    CentrosAltura[3][0]=-0.500000;
    CentrosAltura[4][0]=-0.500000;
    CentrosAltura[5][0]=0.000000;
    CentrosAltura[6][0]=0.000000;
    CentrosAltura[7][0]=0.000000;
    CentrosAltura[8][0]=0.000000;
    CentrosAltura[9][0]=0.000000;
    CentrosAltura[10][0]=0.500000;
    CentrosAltura[11][0]=0.500000;
    CentrosAltura[12][0]=0.500000;
    CentrosAltura[13][0]=1.000000;
    CentrosAltura[14][0]=1.000000;
}
    ...
    switch(numVar)
    {
        case 0:
            ...
            case 0:
                        ...
                        if(x<(-1.000000))
                            ux=1;
                        if(x<(-0.750000)&&x>=(-1.000000))
                            {
                                ux=(x-(-1.000000))/((-0.500000)-(-1.000000));
                                ux=1-2*ux*ux;
                            }
                        if(x<(-0.500000)&&x>=(-0.750000))
                            {
                                ux=(x-(-0.500000))/((-0.500000)-(-1.000000));
                                ux=2*ux*ux;
                            }
                        if(x>=(-0.500000))
                            ux=0;
            ...
            case 1:
                        ...
                        if(x<(-0.250000)&&x>=(-0.500000))
                            {
                                ux=(x-(-0.500000))/((0.000000)-(-0.500000));
                                ux=1-2*ux*ux;
                            }
                        if(x<(0.000000)&&x>=(-0.250000))
                            {
                                ux=(x-(0.000000))/((0.000000)-(-0.500000));
                                ux=2*ux*ux;
                            }
                        if(x>=(0.000000))
                            ux=0;
            ...
            case 2:
                        ...
                        if(x<(0.250000)&&x>=(0.000000))
                            {
                                ux=(x-(0.000000))/((0.500000)-(0.000000));
                                ux=1-2*ux*ux;
                            }
                        if(x<(0.500000)&&x>=(0.250000))
                            {
                                ux=(x-(0.500000))/((0.500000)-(0.000000));
                                ux=2*ux*ux;
                            }
                        if(x>=(0.500000))
                            ux=0;
            ...
            case 3:
                        ...
                        if(x<(0.750000)&&x>=(0.500000))
                            {
                                ux=(x-(0.500000))/((1.000000)-(0.500000));
                                ux=1-2*ux*ux;
                            }
                        if(x<(1.000000)&&x>=(0.750000))
                            {
                                ux=(x-(1.000000))/((1.000000)-(0.500000));
                                ux=2*ux*ux;
                            }
                        if(x>=(1.000000))
                            ux=0;
        ...
        case 1:
            ...
            case 0:
                        ...
                        if(x<(0.000000)&&x>=(-0.500000))
                            {
                                ux=(x-(0.000000))/((0.000000)-(-1.000000));
                                ux=2*ux*ux;
                            }
                        if(x>=(0.000000))
                            ux=0;
            ...
            case 1:
                        ...
                        if(x<(1.000000)&&x>=(0.500000))
                            {
                                ux=(x-(1.000000))/((1.000000)-(0.000000));
                                ux=2*ux*ux;
                            }
                        if(x>=(1.000000))
                            ux=0;

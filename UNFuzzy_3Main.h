...
#ifndef UNFUZZY_3MAIN_H
#define UNFUZZY_3MAIN_H
...
class UNFuzzy_3Dialog: public wxDialog
{
    public:
        UNFuzzy_3Dialog(wxDialog *dlg, const wxString& title);
        ~UNFuzzy_3Dialog();
